<template>
  <footer class="w-full flex justify-center bg-bglight2Color">
    <div class="mt-auto mb-auto max-w-7xl">
      <div
      ...
      >
        <div class="sm:w-1/2">
          ...
          <div class="sm:text-sm text-black pb-6">
            <NuxtLink
              :to="appConfig.appBestHub.url"
              class="hover:text-black"
              style="text-decoration: none"
              aria-label="Acesse a área do Parceiro"
              target="_blank"
            >
              Acesse a área do Parceiro
            </NuxtLink>
          </div>

          <div class="sm:text-sm text-black pb-6">
            <NuxtLink
              :to="appConfig.socialMedia.jobs"
              class="hover:text-black"
              style="text-decoration: none"
          ...
          <div class="md:hidden xl:hidden lg:hidden">
            ...
            <div class="text-black pb-2">
              <NuxtLink
                :to="appConfig.socialMedia.whatsapp"
                :external="true"
              ...
              >
                <p class="flex text-sm">
                  ...
                  <svg
                    ...
                    class="w-4 h-3 mx-1 mt-1 fill-textSecondary"
                    viewBox="0 0 448 512"
                  >
        ...
        <div class="  ">
          ...
          <div class="sm:text-sm text-black pb-6">
            <NuxtLink
              :to="appConfig.appClientAccount.url"
              class="hover:text-black"
              style="text-decoration: none"
          ...
          <div class="md:hidden xl:hidden lg:hidden">
            ...
            <div class="text-xl font-semibold text-black py-4">
              <NuxtLink
                :to="appConfig.socialMedia.location"
                :external="true"
                class="hover:text-textPrimary"
                style="text-decoration: none"
            ...
            <div id="ra-verified-seal">
              <NuxtLink
                to="https://www.reclameaqui.com.br/empresa/best-fintech-de-credito-imobiliario/?utm_source=referral&utm_medium=embbed&utm_campaign=ra_verificada&utm_term=horizontal"
                :external="true"
                class="hover:text-textPrimary"
                style="text-decoration: none"
              ...
              >
                <NuxtImg
                  src="/images/logos/relamequi.webp"
        ...
        <div class="sm:hidden">
          ...
          <div class="text-black pb-2">
            <NuxtLink
              ...
              target="_blank"
            >
              <p class="flex sm:justify-center">
                (47) 3311-0180
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-4 h-4 mx-1 mt-1 fill-textSecondary"
                  viewBox="0 0 448 512"
                >
                  <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                  <path
          ...
          <div id="ra-verified-seal">
            <a
              href="https://www.reclameaqui.com.br/empresa/best-fintech-de-credito-imobiliario/?utm_source=referral&utm_medium=embbed&utm_campaign=ra_verificada&utm_term=horizontal"
              class="hover:text-textPrimary"
              style="text-decoration: none"
            ...
            >
              <NuxtImg
                src="/images/logos/reclameaqui.webp"
                alt="Empresa verificada Reclame Aqui "
                title="Empresa verificada Reclame Aqui "
                class="w-auto h-12 rounded-xl"
              />
      ...
      <div class="maxWidth mt-12">
        <div class="w-full flex sm:flex-wrap justify-between py-2 sm:px-2">
          ...
          >
            <NuxtLink
              :to="appConfig.socialMedia.youtube"
              :external="true"
            ...
            >
              <svg
                class="w-8 h-8 sm:w-6 sm:h-6 mx-2 fill-textSecondary"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512"
              >
                <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
            ...
            <NuxtLink
              :to="appConfig.socialMedia.linkedin"
              :external="true"
              style="text-decoration: none"
            ...
            <NuxtLink
              :to="appConfig.socialMedia.instagram"
              :external="true"
            ...
            <NuxtLink
              :to="appConfig.socialMedia.facebook"
              :external="true"
            ...
            <NuxtLink
              :to="appConfig.socialMedia.telegram"
              :external="true"
        ...
        <div class="sm:px-2 sm:py-6 py-8">
          <p class="text-xs text-black">
            ...
            3.954, de 24 de fevereiro de 2011. Somos correspondentes bancários
            das seguintes instituições: banco Daycoval S. A cnpj sob o no
            62.232.889/0001-90. banco Santander s.a. cnpj sob o no
            90.400.888/0001-42 Cashme soluções financeiras Ltda. cnpj sob o no
            34.175.529/0001-68. Itaú Unibanco s.a. cnpj sob o no
            60.701.190/0001-04. companhia promotora Uci cnpj sob o no
            14.010.548/0001-27. Pontte soluções financeiras Ltda. cnpj sob o no
            33.296.599/0001-01. banco Bari de investimentos e financiamentos
            S.A. cnpj sob o no 00.556.603/0001-74. companhia hipotecaria
            piratini – CHP. cnpj sob o no 18.282.093/0001-50. B.V. financeira
          ...
          <p class="text-xs text-black py-4">
            ...
            R$ 1.488,08, com uma taxa de juros de 1,09% ao mês + IPCA, Sistema
          ...
          <div class="">
            <LogoBacen class="w-40 h-auto text-textSecondary" />
          </div>
        </div>
      </div>
    </div>
...
import LogoBacen from "@/assets/svg/logos/bacen.vue";
import LogoSejaBest from "@/assets/svg/logos/sejabest.vue";
