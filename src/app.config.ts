export default defineAppConfig({
  appSimulator: {
    url: "https://simulador.seja.best/",
  },
  appClientAccount: {
    url: "https://seja.best/conta",
  },
  appBestHub: {
  ...
  socialMedia: {
    ...
    telegram:
      " https://t.me/sejabest?utm_source=landingpagenews&utm_campaign=bestnewstelegram&utm_content=telegramsejabest",
    whatsapp:
